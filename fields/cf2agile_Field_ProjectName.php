...
class cf2Agile_Field_ProjectName extends cf2Agile_Field {

	/**
	 * @inheritdoc
	 */
    public function __construct() {
        $this->_tag_name = 'cf2agile__project_name';
        $this->_tag_title = __( 'Project Name', 'cf2agile' );
...
new cf2Agile_Field_ProjectName();
