...
class cf2agile_Field_CompanyName extends cf2Agile_Field {

	/**
	 * @inheritdoc
	 */
	public function __construct() {
		$this->_tag_name = 'cf2agile__company_name';
		$this->_tag_title = __( 'Customer Company Name', 'cf2agile' );
...
new cf2agile_Field_CompanyName();
