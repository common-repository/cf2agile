...
class cf2agile_Field_CustomerEmail extends cf2Agile_Field {

	/**
	 * @inheritdoc
	 */
	public function __construct() {
		$this->_tag_name = 'cf2agile__customer_email';
		$this->_tag_title = __( 'Customer Email', 'cf2agile' );
...
new cf2agile_Field_CustomerEmail();
